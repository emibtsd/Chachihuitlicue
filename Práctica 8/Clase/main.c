...
// Inicializar una lectura analogica

// Para tener mas lecturas analogicas solo modificar ANSEL's
void ADC_Init(){
    ANSEL= 0x03;   // Establecer pines analogicos a digitales - este equivale a 0b00000011
    ANSELH= 0;
    ADCON0= 0x01;
    ADCON1= 0x80;   
}
